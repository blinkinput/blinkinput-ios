 ...
 * (if enabled in MBIBaseOcrEngineOptions). Due to differences between parsing normal strings
 ...
 * Regex parser result
 */
@property (nonatomic, strong, readonly) MBIRegexParserResult *result;
 ...
 */
@property (nonatomic, strong) MBIBaseOcrEngineOptions *ocrEngineOptions;

...
@protocol MBINTemplatingClassifier;

@class MBINProcessorGroup;
...
@interface MBINTemplatingClass : NSObject
 ...
 */
- (void)setClassificationProcessorGroups:(nonnull NSArray<__kindof MBINProcessorGroup *> *)processorGroups;
 ...
 */
- (nullable NSArray<__kindof MBINProcessorGroup *> *)getClassificationProcessorGroups;

/**
 * Sets processor groups that will be executed if MBINTemplatingClassifier's classify returns YES.
 * @param processorGroups processor groups that will be executed after classification, if classification is positive
 */
- (void)setNonClassificationProcessorGroups:(nonnull NSArray<__kindof MBINProcessorGroup *> *)processorGroups;
 ...
 */
- (nullable NSArray<__kindof MBINProcessorGroup *> *)getNonClassificationProcessorGroups;
 ...
 */
- (void)setTemplatingClassifier:(nullable id<MBINTemplatingClassifier>)templatingClassifier;

@end

@protocol MBINTemplatingClassifier <NSObject>
@required

...
@interface MBINMrtdDetector : MBINQuadWithSizeDetector <NSCopying>
 ...
 */
@property (nonatomic, strong, readonly) MBINMrtdDetectorResult *result;
 ...
 * MRTD detector has found the document, it will internally use MBINDocumentDetector
 ...
 */
- (void)setMrtdSpecifications:(NSArray<__kindof MBINMrtdSpecification *> *)mrtdSpecifications;

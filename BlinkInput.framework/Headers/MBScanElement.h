 ...
 */
- (instancetype)initWithIdentifier:(NSString *)identifier parser:(MBIParser *)parser NS_DESIGNATED_INITIALIZER;
 ...
 */
@property(nonatomic, strong, readonly) MBIParser *parser;
 ...
 */
@property(nonatomic) MBIImage *successfulScanImage;

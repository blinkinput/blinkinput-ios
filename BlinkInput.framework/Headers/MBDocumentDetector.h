...
@interface MBINDocumentDetector : MBINQuadWithSizeDetector <NSCopying>
 ...
 */
- (instancetype)initWithDocumentSpecifications:(NSArray<__kindof MBINDocumentSpecification *> *)documentSpecifications NS_DESIGNATED_INITIALIZER;

/**
 * Document detector result
 */
@property (nonatomic, strong, readonly) MBINDocumentDetectorResult *result;
 ...
 * document detector.
 */
@property (nonatomic, strong, readonly, nonnull) NSArray<__kindof MBINDocumentSpecification *> *documentSpecifications;

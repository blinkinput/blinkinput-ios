...
@interface MBINOverlayViewController : UIViewController
 ...
 */
@property (nonatomic, weak) UIViewController<MBINOverlayContainerViewController> *recognizerRunnerViewController;

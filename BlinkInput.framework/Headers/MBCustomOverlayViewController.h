...
@interface MBINCustomOverlayViewController : MBINOverlayViewController

@property (nonatomic, readonly, strong) MBINRecognizerCollection *recognizerCollection;
@property (nonatomic, readonly, strong) MBINCameraSettings *cameraSettings;
@property (nonatomic, strong) MBINRecognizerRunnerViewControllerMetadataDelegates *metadataDelegates;
@property (nonatomic, weak) id<MBINScanningRecognizerRunnerViewControllerDelegate> scanningRecognizerRunnerViewControllerDelegate;
@property (nonatomic, weak) id<MBINRecognizerRunnerViewControllerDelegate> recognizerRunnerViewControllerDelegate;

/**
 * Convenience initializer used for use cases when overlay view controller is instantiated from storyboard.
 * It creates default MBINCameraSettings and empty MBINRecognizerCollection. To add recognizers after this
 * initializer is used, please use reconfigureRecognizers:.
 */
- (instancetype)init;

- (instancetype)initWithRecognizerCollection:(MBINRecognizerCollection *)recognizerCollection cameraSettings:(MBINCameraSettings *)cameraSettings NS_DESIGNATED_INITIALIZER;

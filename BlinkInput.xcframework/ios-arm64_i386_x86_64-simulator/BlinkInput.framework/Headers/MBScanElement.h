...
/**
 * The easiest way to UI for Ocr scanning is by specifying the MBINScanElements.
 *
 * Each MBINScanElement knows
...
@interface MBINScanElement : NSObject
 ...
 */
- (instancetype)initWithIdentifier:(NSString *)identifier parser:(MBINParser *)parser NS_DESIGNATED_INITIALIZER;
 ...
 */
@property(nonatomic, strong, readonly) MBINParser *parser;
 ...
 *
 * Images will NOT be outputted unless outputSuccessfulImages is enabled on MBINFieldByFieldOverlaySettings.
 */
@property(nonatomic) MBINImage *successfulScanImage;

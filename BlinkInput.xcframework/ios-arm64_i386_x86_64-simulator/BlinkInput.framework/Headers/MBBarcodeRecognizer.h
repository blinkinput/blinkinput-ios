...
/**
 * MBINBarcodeRecognizer is used for scanning most of 1D barcode formats, and 2D format
 * such as Aztec, DataMatrix and QR code
 */
MB_CLASS_AVAILABLE_IOS(8.0) MB_FINAL
@interface MBINBarcodeRecognizer : MBINRecognizer<NSCopying>
 ...
 */
@property (nonatomic, strong, readonly) MBINBarcodeRecognizerResult *result;

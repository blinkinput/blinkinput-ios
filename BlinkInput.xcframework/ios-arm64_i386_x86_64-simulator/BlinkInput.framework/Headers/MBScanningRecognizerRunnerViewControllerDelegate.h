 ...
 */
@protocol MBINScanningRecognizerRunnerViewControllerDelegate <NSObject>
@required
/**
...
- (void)recognizerRunnerViewControllerDidFinishScanning:(nonnull UIViewController<MBINRecognizerRunnerViewController> *)recognizerRunnerViewController state:(MBINRecognizerResultState)state;

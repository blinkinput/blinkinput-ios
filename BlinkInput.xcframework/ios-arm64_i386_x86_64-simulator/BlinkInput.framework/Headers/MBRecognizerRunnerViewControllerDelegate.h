 ...
 */
- (void)recognizerRunnerViewControllerUnauthorizedCamera:(nonnull UIViewController<MBIRecognizerRunnerViewController> *)recognizerRunnerViewController;
 ...
 */
- (void)recognizerRunnerViewController:(nonnull UIViewController<MBIRecognizerRunnerViewController> *)recognizerRunnerViewController didFindError:(NSError *)error;
 ...
 */
- (void)recognizerRunnerViewControllerDidClose:(nonnull UIViewController<MBIRecognizerRunnerViewController> *)recognizerRunnerViewController;
 ...
 */
- (void)recognizerRunnerViewControllerWillPresentHelp:(nonnull UIViewController<MBIRecognizerRunnerViewController> *)recognizerRunnerViewController;
 ...
 *  @param recognizerRunnerViewController recognizerRunnerViewController Recognizer runner view controller responsible for scanning
 */
- (void)recognizerRunnerViewControllerDidResumeScanning:(nonnull UIViewController<MBIRecognizerRunnerViewController> *)recognizerRunnerViewController;
 ...
 *  @param recognizerRunnerViewController recognizerRunnerViewController Recognizer runner view controller responsible for scanning
 */
- (void)recognizerRunnerViewControllerDidStopScanning:(nonnull UIViewController<MBIRecognizerRunnerViewController> *)recognizerRunnerViewController;
 ...
 */
- (void)recognizerRunnerViewController:(nonnull UIViewController<MBIRecognizerRunnerViewController> *)recognizerRunnerViewController willSetTorch:(BOOL)isTorchOn;

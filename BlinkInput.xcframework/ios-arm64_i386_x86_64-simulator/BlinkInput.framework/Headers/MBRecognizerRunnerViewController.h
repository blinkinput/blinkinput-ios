...
typedef void(^MBICaptureHighResImage)(MBIImage * _Nullable highResImage);
...
/**
 * MBIRecognizerRunnerViewController's shouldAutorotate will return this value.
 *
 * Default: NO.
 *
...
/**
 * MBIRecognizerRunnerViewController's supportedInterfaceOrientations will return this value.
 *
 ...
 * Play scan sound.
 *
 * It uses default scan sound, you can change it by setting your own soundFilePath in MBIOverlaySettings.
 */
 ...
 */
- (void)captureHighResImage:(MBICaptureHighResImage)highResoulutionImageCaptured;

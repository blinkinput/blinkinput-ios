...
@interface MBINViewControllerFactory : NSObject
 ...
 * The only requirement for the overlay view is that it's a subclass of MBINOverlayViewController
 *
 ...
 */
+ (nullable UIViewController<MBINRecognizerRunnerViewController> *)recognizerRunnerViewControllerWithOverlayViewController:(nonnull MBINOverlayViewController *)overlayViewController NS_SWIFT_NAME(recognizerRunnerViewController(withOverlayViewController:));

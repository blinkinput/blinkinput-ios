 ...
 * The only requirement for the overlay view is that it's a subclass of MBIOverlayViewController
 *
 ...
 */
+ (nullable UIViewController<MBIRecognizerRunnerViewController> *)recognizerRunnerViewControllerWithOverlayViewController:(nonnull MBIOverlayViewController *)overlayViewController NS_SWIFT_NAME(recognizerRunnerViewController(withOverlayViewController:));

...
static inline NSString * MBI_LOCALIZED(NSString *key) {
    ...
    NSString *localizedString = MBI_LOCALIZED_FOR_LANGUAGE(key, [MBIMicroblinkApp sharedInstance].language);
    
#ifndef DNDEBUG
    return localizedString;
#else
    if ([localizedString isEqualToString:MBI_LOCALIZED_DEFAULT_STRING(key)] && ![MBIMicroblinkApp.sharedInstance.language isEqualToString:@"en"]) {

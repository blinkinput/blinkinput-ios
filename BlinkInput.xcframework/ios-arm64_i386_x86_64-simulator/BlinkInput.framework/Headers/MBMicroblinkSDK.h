...
@interface MBINMicroblinkSDK : NSObject
 ...
 */
- (void)setLicenseBuffer:(NSData * _Nonnull)licenseBuffer errorCallback:(MBINLicenseErrorBlock)errorCallback;
 ...
 * @param errorCallback A block that get executed when an issue with the license occurs. The only parameter represents the type of the issue.
 */
- (void)setLicenseBuffer:(NSData * _Nonnull)licenseBuffer andLicensee:(NSString * _Nonnull)licensee errorCallback:(MBINLicenseErrorBlock)errorCallback;
 ...
 * @param errorCallback A block that get executed when an issue with the license occurs. The only parameter represents the type of the issue.
 */
- (void)setLicenseKey:(NSString * _Nonnull)base64LicenseKey errorCallback:(MBINLicenseErrorBlock)errorCallback;
 ...
 * @param errorCallback A block that get executed when an issue with the license occurs. The only parameter represents the type of the issue.
 */
- (void)setLicenseKey:(NSString * _Nonnull)base64LicenseKey andLicensee:(NSString * _Nonnull)licensee errorCallback:(MBINLicenseErrorBlock)errorCallback;
 ...
 * @param errorCallback A block that get executed when an issue with the license occurs. The only parameter represents the type of the issue.
 */
- (void)setLicenseResource:(NSString * _Nonnull)fileName withExtension:(NSString * _Nullable)extension inSubdirectory:(NSString * _Nullable)subdirectory forBundle:(NSBundle * _Nonnull)bundle errorCallback:(MBINLicenseErrorBlock)errorCallback;
 ...
 * @param errorCallback A block that get executed when an issue with the license occurs. The only parameter represents the type of the issue.
 */
- (void)setLicenseResource:(NSString * _Nonnull)fileName withExtension:(NSString * _Nullable)extension inSubdirectory:(NSString * _Nullable)subdirectory forBundle:(NSBundle * _Nonnull)bundle andLicensee:(NSString *)licensee errorCallback:(MBINLicenseErrorBlock)errorCallback;
 ...
 */
+ (BOOL)isScanningUnsupportedForCameraType:(MBINCameraType)type error:(NSError *_Nullable *_Nullable)error NS_SWIFT_NOTHROW;

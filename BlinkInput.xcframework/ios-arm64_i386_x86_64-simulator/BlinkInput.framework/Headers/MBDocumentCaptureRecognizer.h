...
@interface MBINDocumentCaptureRecognizer : MBINRecognizer<NSCopying, MBINFullDocumentImage, MBINEncodeFullDocumentImage, MBINFullDocumentImageExtensionFactors>
 ...
 */
@property (nonatomic, strong, readonly) MBINDocumentCaptureRecognizerResult *result;

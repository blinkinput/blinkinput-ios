...
/**
 * MBINAmountParser is used for extracting amount from OCR result
 */
MB_CLASS_AVAILABLE_IOS(8.0) MB_FINAL
@interface MBINAmountParser : MBINParser <NSCopying>
 ...
 */
@property (nonatomic, strong, readonly) MBINAmountParserResult *result;

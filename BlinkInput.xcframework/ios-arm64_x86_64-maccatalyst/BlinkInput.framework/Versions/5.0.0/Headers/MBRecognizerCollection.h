...
/**
 * Contains MBIRecognizer objects - each individual recognizer.
 ...
 * @see MBIRecognizer.
 */
@property (nonatomic, strong) NSArray<MBIRecognizer *> *recognizerList;

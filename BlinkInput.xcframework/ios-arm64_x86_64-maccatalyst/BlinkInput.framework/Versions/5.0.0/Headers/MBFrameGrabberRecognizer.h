...
@protocol MBIFrameGrabberRecognizerDelegate;
...
- (instancetype)initWithFrameGrabberDelegate:(id<MBIFrameGrabberRecognizerDelegate>)frameGrabberDelegate NS_SWIFT_NAME(init(frameGrabberDelegate:));

/**
 * Allow sending focused camera frames to MBIFrameGrabberRecognizerDelegate.
 *
 * Default: YES
 */
...
/**
 * Allow sending unfocused camera frames to MBIFrameGrabberRecognizerDelegate.
 *
 * Default: NO
 */

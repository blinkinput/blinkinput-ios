 ...
 * actual physical size provided by the MBINQuadWithSizeDetector
 * and requested DPI (dots per inch).
 *
 * This policy is usually best for processor groups that prepare
 * image for output (e.g. MBINImageReturnProcessor).
 */
MB_CLASS_AVAILABLE_IOS(8.0) MB_FINAL
@interface MBINDPIBasedDewarpPolicy : MBINDewarpPolicy

...
@protocol MBINEncodedFullDocumentImageResult

@required

/**
 * JPEG-encoded full document image if enabled with `MBINEncodeFullDocumentImage encodeFullDocumentImage` property.
 */

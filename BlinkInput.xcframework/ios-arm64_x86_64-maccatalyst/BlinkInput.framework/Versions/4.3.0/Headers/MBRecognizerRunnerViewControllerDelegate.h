...
/**
 * Protocol for MBINRecognizerRunnerViewController actions
 */
@protocol MBINRecognizerRunnerViewControllerDelegate <NSObject>
@required
/**
 ...
 */
- (void)recognizerRunnerViewControllerUnauthorizedCamera:(nonnull UIViewController<MBINRecognizerRunnerViewController> *)recognizerRunnerViewController;
 ...
 */
- (void)recognizerRunnerViewController:(nonnull UIViewController<MBINRecognizerRunnerViewController> *)recognizerRunnerViewController didFindError:(NSError *)error;
 ...
 */
- (void)recognizerRunnerViewControllerDidClose:(nonnull UIViewController<MBINRecognizerRunnerViewController> *)recognizerRunnerViewController;
 ...
 */
- (void)recognizerRunnerViewControllerWillPresentHelp:(nonnull UIViewController<MBINRecognizerRunnerViewController> *)recognizerRunnerViewController;
 ...
 *  @param recognizerRunnerViewController recognizerRunnerViewController Recognizer runner view controller responsible for scanning
 */
- (void)recognizerRunnerViewControllerDidResumeScanning:(nonnull UIViewController<MBINRecognizerRunnerViewController> *)recognizerRunnerViewController;
 ...
 *  @param recognizerRunnerViewController recognizerRunnerViewController Recognizer runner view controller responsible for scanning
 */
- (void)recognizerRunnerViewControllerDidStopScanning:(nonnull UIViewController<MBINRecognizerRunnerViewController> *)recognizerRunnerViewController;
 ...
 */
- (void)recognizerRunnerViewController:(nonnull UIViewController<MBINRecognizerRunnerViewController> *)recognizerRunnerViewController willSetTorch:(BOOL)isTorchOn;

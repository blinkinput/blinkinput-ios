...
@protocol MBINFrameGrabberRecognizerDelegate;
...
@interface MBINFrameGrabberRecognizer : MBINRecognizer<NSCopying>

- (instancetype)init NS_UNAVAILABLE;
- (instancetype)initWithFrameGrabberDelegate:(id<MBINFrameGrabberRecognizerDelegate>)frameGrabberDelegate NS_SWIFT_NAME(init(frameGrabberDelegate:));

/**
 * Allow sending focused camera frames to MBINFrameGrabberRecognizerDelegate.
 *
 * Default: YES
 */
...
/**
 * Allow sending unfocused camera frames to MBINFrameGrabberRecognizerDelegate.
 *
 * Default: NO
 */
...
@protocol MBINFrameGrabberRecognizerDelegate <NSObject>
@required
/**
 ...
 * @param cameraFrame The {MBINImage} containing frame that will be processed.
 ...
 */
- (void)onFrameAvailable:(MBINImage *)cameraFrame isFocused:(BOOL)focused frameQuality:(CGFloat)frameQuality;

...
@class MBINOverlayViewController;
@class MBINImage;

/** Block for returning high resolution MBINImage photo with capture or still output */
typedef void(^MBINCaptureHighResImage)(MBINImage * _Nullable highResImage);
 ...
 */
@protocol MBINRecognizerRunnerViewController <NSObject>

/**
 * MBINRecognizerRunnerViewController's shouldAutorotate will return this value.
 *
 * Default: NO.
 *
...
/**
 * MBINRecognizerRunnerViewController's supportedInterfaceOrientations will return this value.
 *
 ...
 * Play scan sound.
 *
 * It uses default scan sound, you can change it by setting your own soundFilePath in MBINOverlaySettings.
 */
 ...
 */
- (void)captureHighResImage:(MBINCaptureHighResImage)highResoulutionImageCaptured;

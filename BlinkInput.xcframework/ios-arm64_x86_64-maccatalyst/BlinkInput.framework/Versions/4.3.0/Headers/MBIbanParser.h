...
/**
 * MBINAmountParser that can extract IBAN (International Bank Account Number) from OCR result.
 */
MB_CLASS_AVAILABLE_IOS(8.0) MB_FINAL
@interface MBINIbanParser : MBINParser <NSCopying>
 ...
 * Iban parser result
 */
@property (nonatomic, strong, readonly) MBINIbanParserResult *result;

...
@interface MBINFieldByFieldOverlaySettings : MBINOverlaySettings

/**
 * Designated initializer for settings.
 */
- (instancetype)initWithScanElements:(NSArray<MBINScanElement *> *)scanElements NS_DESIGNATED_INITIALIZER;

MB_INIT_UNAVAILABLE;

/**
 * Array of MBINScanElement objects which defines which Elements are scanned.
 */
@property(nonatomic, strong, readonly) NSArray<MBINScanElement *> *scanElements;

...
@interface MBINProcessorGroup : NSObject

MB_INIT_UNAVAILABLE

/**
 * Constructor for MBINProcessorGroup.
 *
 ...
 */
- (instancetype)initWithProcessingLocation:(CGRect)processingLocation dewarpPolicy:(nonnull MBINDewarpPolicy *)dewarpPolicy andProcessors:(nonnull NSArray<__kindof MBINProcessor *> *)processors NS_DESIGNATED_INITIALIZER;

/**
 * Processors that are members of the processor group
 */
@property (nonatomic, strong, readonly) NSArray<__kindof MBINProcessor *> *processors;

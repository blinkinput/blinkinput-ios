...
@interface MBINDocumentCaptureRecognizerResult : MBINRecognizerResult<NSCopying, MBINFullDocumentImageResult, MBINEncodedFullDocumentImageResult>
 ...
 */
@property (nonatomic, readonly) MBINQuadrangle *detectionLocation;

...
/**
 ...
 Those are events specified by MBINOverlayViewControllerDelegate protocol.
 */
@protocol MBINOverlayContainerViewController <MBINRecognizerRunnerViewController>
 ...
 */
- (void)overlayViewControllerWillCloseCamera:(MBINOverlayViewController *)overlayViewController;
 ...
 */
- (BOOL)overlayViewControllerShouldDisplayTorch:(MBINOverlayViewController *)overlayViewController;
 ...
 */
- (BOOL)overlayViewController:(MBINOverlayViewController *)overlayViewController willSetTorch:(BOOL)isTorchOn;

/**
 * If help mechanism is implemented using MBINScanDelegate's scanningViewControllerWillPresentHelp method,

 ...
 * (if enabled in MBINBaseOcrEngineOptions). Due to differences between parsing normal strings
 * and OCR results, this parser does not support some regex features found in java's regex engine,
 * like back references.
 */
MB_CLASS_AVAILABLE_IOS(8.0) MB_FINAL
@interface MBINRegexParser : MBINParser <NSCopying>
 ...
 * Regex parser result
 */
@property (nonatomic, strong, readonly) MBINRegexParserResult *result;
 ...
 *
 * Default: default instance of MBINOcrEngineOptions
 */
@property (nonatomic, strong) MBINBaseOcrEngineOptions *ocrEngineOptions;

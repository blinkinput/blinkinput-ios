...
/**
 * MBINRawParser that simply returns the string version of raw OCR result, without performing
 * any smart parsing operations.
 */
MB_CLASS_AVAILABLE_IOS(8.0) MB_FINAL
@interface MBINRawParser : MBINParser <NSCopying>
 ...
 */
@property (nonatomic, strong, readonly) MBINRawParserResult *result;

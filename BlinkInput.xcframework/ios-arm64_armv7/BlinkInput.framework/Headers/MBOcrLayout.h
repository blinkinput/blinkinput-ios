...
@interface MBINOcrLayout : NSObject
 ...
 */
@property (nonatomic) NSArray<MBINOcrBlock *> *blocks;
 ...
 */
@property (nonatomic) MBINPosition *position;
 ...
 */
- (instancetype)initWithOcrBlocks:(NSArray<MBINOcrBlock *> *)ocrBlocks
 ...
 */
MB_CLASS_AVAILABLE_IOS(8.0)
@interface MBINOcrBlock : NSObject

/**
 * Ocr lines of the block
 */
@property (nonatomic) NSArray<MBINOcrLine *> *lines;
 ...
 */
- (instancetype)initWithOcrLines:(NSArray<MBINOcrLine *> *)ocrLines position:(MBINPosition *)position NS_DESIGNATED_INITIALIZER;
 ...
 */
MB_CLASS_AVAILABLE_IOS(8.0)
@interface MBINOcrLine : NSObject

/**
 * Ocr chars of the line
 */
@property (nonatomic) NSArray<MBINCharWithVariants *> *chars;
 ...
 */
- (instancetype)initWithOcrChars:(NSArray<MBINCharWithVariants *> *)ocrChars position:(MBINPosition *)position NS_DESIGNATED_INITIALIZER;
...
MB_CLASS_AVAILABLE_IOS(8.0)
@interface MBINCharWithVariants : NSObject

/**
 * Character that was recognised
 */
@property (nonatomic) MBINOcrChar * character;
 ...
 */
- (instancetype)initWithValue:(MBINOcrChar *)character NS_DESIGNATED_INITIALIZER;
 ...
 */
MB_CLASS_AVAILABLE_IOS(8.0)
@interface MBINOcrChar : NSObject
 ...
 */
@property (nonatomic) MBINOcrFont font;
 ...
 */
- (instancetype)initWithValue:(unichar)value position:(MBINPosition *)position height:(CGFloat)height NS_DESIGNATED_INITIALIZER;
 ...
 */
MB_CLASS_AVAILABLE_IOS(8.0)
@interface MBINPosition : NSObject
 ...
 */
- (MBINPosition *)positionWithOffset:(CGPoint)offset;

 ...
 */
typedef NS_ENUM(NSInteger, MBINDeepOcrModel) {

    /** Deep OCR model for Blink Input */
    MBINDeepOcrModelBlinkInput
};
...
@interface MBINDeepOcrEngineOptions : MBINBaseOcrEngineOptions <NSCopying>
 ...
 *
 * Default: MBINBlinkOCR
 */
@property (nonatomic, assign) MBINDeepOcrModel deepOcrModel;

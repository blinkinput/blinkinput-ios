 ...
 */
typedef NS_ENUM(NSInteger, MBITopUpPreset) {
 ...
 */
@property (nonatomic, strong, readonly) MBITopUpParserResult *result;
...
/**
 * Sets the top up prefix and USSD code length based on the given MBITopUpPreset. Only

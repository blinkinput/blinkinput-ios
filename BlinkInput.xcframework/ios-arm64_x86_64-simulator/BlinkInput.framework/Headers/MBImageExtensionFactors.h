 ...
 */
typedef struct MBIImageExtensionFactors {
    CGFloat top;
    CGFloat right;
    CGFloat bottom;
    CGFloat left;
 ...
 */
NS_INLINE MBIImageExtensionFactors MBIMakeImageExtensionFactors(CGFloat top, CGFloat right, CGFloat bottom, CGFloat left) {
    MBIImageExtensionFactors factors;
    factors.top = top;
    factors.right = right;

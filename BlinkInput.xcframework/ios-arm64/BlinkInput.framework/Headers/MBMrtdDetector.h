 ...
 */
@property (nonatomic, strong, readonly) MBIMrtdDetectorResult *result;
 ...
 * MRTD detector has found the document, it will internally use MBIDocumentDetector
 ...
 */
- (void)setMrtdSpecifications:(NSArray<__kindof MBIMrtdSpecification *> *)mrtdSpecifications;

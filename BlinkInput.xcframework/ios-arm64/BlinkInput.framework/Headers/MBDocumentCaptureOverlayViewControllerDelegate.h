 ...
 * NOTE: This method is called on background processing thread. Make sure that you dispatch all your UI API calls to main thread.
 */
- (void)documentCaptureOverlayViewControllerDidCaptureHighResolutionImage:(nonnull MBIDocumentCaptureOverlayViewController *)documentCaptureOverlayViewController highResImage:(MBIImage *)highResImage state:(MBIRecognizerResultState)state;

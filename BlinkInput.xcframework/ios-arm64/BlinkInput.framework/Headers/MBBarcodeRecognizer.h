...
/**
 * MBIBarcodeRecognizer is used for scanning most of 1D barcode formats, and 2D format
 */
 ...
 */
@property (nonatomic, strong, readonly) MBIBarcodeRecognizerResult *result;

 ...
 */
- (instancetype)initWithScanElements:(NSArray<MBIScanElement *> *)scanElements NS_DESIGNATED_INITIALIZER;

MB_INIT_UNAVAILABLE;

/**
 * Array of MBIScanElement objects which defines which Elements are scanned.
 */
@property(nonatomic, strong, readonly) NSArray<MBIScanElement *> *scanElements;

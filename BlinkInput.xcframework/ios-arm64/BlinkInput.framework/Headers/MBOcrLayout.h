 ...
 */
@property (nonatomic) NSArray<MBIOcrBlock *> *blocks;
 ...
 */
@property (nonatomic) MBIPosition *position;
 ...
 */
- (instancetype)initWithOcrBlocks:(NSArray<MBIOcrBlock *> *)ocrBlocks
 ...
 */
@property (nonatomic) NSArray<MBIOcrLine *> *lines;
 ...
 */
- (instancetype)initWithOcrLines:(NSArray<MBIOcrLine *> *)ocrLines position:(MBIPosition *)position NS_DESIGNATED_INITIALIZER;
 ...
 */
@property (nonatomic) NSArray<MBICharWithVariants *> *chars;
 ...
 */
- (instancetype)initWithOcrChars:(NSArray<MBICharWithVariants *> *)ocrChars position:(MBIPosition *)position NS_DESIGNATED_INITIALIZER;
...
MB_CLASS_AVAILABLE_IOS(8.0)
@interface MBICharWithVariants : NSObject

/**
 * Character that was recognised
 */
@property (nonatomic) MBIOcrChar * character;
 ...
 */
- (instancetype)initWithValue:(MBIOcrChar *)character NS_DESIGNATED_INITIALIZER;
 ...
 */
- (instancetype)initWithValue:(unichar)value position:(MBIPosition *)position height:(CGFloat)height NS_DESIGNATED_INITIALIZER;
 ...
 */
- (MBIPosition *)positionWithOffset:(CGPoint)offset;

 ...
 */
- (instancetype)initWithProcessingLocation:(CGRect)processingLocation dewarpPolicy:(nonnull MBIDewarpPolicy *)dewarpPolicy andProcessors:(nonnull NSArray<__kindof MBIProcessor *> *)processors NS_DESIGNATED_INITIALIZER;

/**
 * Processors that are members of the processor group
 */
@property (nonatomic, strong, readonly) NSArray<__kindof MBIProcessor *> *processors;

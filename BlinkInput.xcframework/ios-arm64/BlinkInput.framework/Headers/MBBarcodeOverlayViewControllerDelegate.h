 ...
 *
 */
- (void)barcodeOverlayViewControllerDidFinishScanning:(nonnull MBIBarcodeOverlayViewController *)barcodeOverlayViewController state:(MBIRecognizerResultState)state;
 ...
 */
- (void)barcodeOverlayViewControllerDidTapClose:(nonnull MBIBarcodeOverlayViewController *)barcodeOverlayViewController;

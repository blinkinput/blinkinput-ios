...
- (PPCameraCoordinator *)coordinatorWithError:(NSError**)error {
    ...
    settings.licenseSettings.licenseKey = @"B7HHTPEC-AFQ3IELO-DE5QC46N-TIHV5OQW-V2F22BDB-UNXBSN4D-MVOM7ZOV-C7U3EM7T"; // Valid temporarily
     ...
     */
    {
        ...
        /** Setup first name decoding */
        {
             ...
             */
            [oldIdDecodingInfoArray addObject:[[PPDecodingInfo alloc] initWithLocation:oldIdNameLocation dewarpedHeight:dewarpHeight uniqueId:ID_FIRST_NAME]];
            [newIdDecodingInfoArray addObject:[[PPDecodingInfo alloc] initWithLocation:newIdNameLocation dewarpedHeight:dewarpHeight uniqueId:ID_FIRST_NAME]];
        }
        ...
        /** Setup last name decoding */
        {
            ...
            [oldIdDecodingInfoArray addObject:[[PPDecodingInfo alloc] initWithLocation:oldIdNameLocation dewarpedHeight:dewarpHeight uniqueId:ID_LAST_NAME]];
        ...
        /** Setup sex, citizenship and date of birth */
        {
             ...
             * We can use 1 Decoding info and parse the whole image with each parser to maximize performance. (this way we parser 1 image 3 times, instead of 3 images each once)
             */
            ...
            /**
             * To have multiple parsers on 1 decoding info we need to have them all in the same group. That group must have the same id (group name) as decoding info uniqueId.
             */
            
            CGRect oldLocation = CGRectMake(0.412, 0.500, 0.259, 0.296);
            CGRect newLocation = CGRectMake(0.388, 0.500, 0.282, 0.296);
            
            [oldIdDecodingInfoArray addObject:[[PPDecodingInfo alloc] initWithLocation:oldLocation dewarpedHeight:300 uniqueId:ID_SEX_CITIZENSHIP_DOB]];
            [newIdDecodingInfoArray addObject:[[PPDecodingInfo alloc] initWithLocation:newLocation dewarpedHeight:300 uniqueId:ID_SEX_CITIZENSHIP_DOB]];
        }
    ...
    for (PPRecognizerResult* result in results) {
        ...
        if ([result isKindOfClass:[PPBlinkOcrRecognizerResult class]]) {
            ...
            message = [ocrResult parsedResultForName:ID_SEX parserGroup:ID_SEX_CITIZENSHIP_DOB];
                        ...
                        message = [[message stringByAppendingString:@" "] stringByAppendingString:[ocrResult parsedResultForName:ID_FIRST_NAME parserGroup:ID_FIRST_NAME]];

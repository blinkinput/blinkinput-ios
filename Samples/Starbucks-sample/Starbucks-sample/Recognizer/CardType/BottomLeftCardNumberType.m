...
- (instancetype)init {
    ...
    PPRegexOcrParserFactory *securityCodeRegexParser = [BaseCardType createParserWithCharWhiteList:[BaseCardType numberWhitelist]
    ...
    PPRegexOcrParserFactory *cardNumberRegexParser = [BaseCardType createParserWithCharWhiteList:[BaseCardType charAndNumberWhiteList]
